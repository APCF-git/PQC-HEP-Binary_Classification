...
classifier_script = textwrap.dedent(f"""\
    # classifier.py
    # Standalone classifier — generated by PQC_HEP_training_file_Gram-Schmidt.py
    # Run timestamp  : {timestamp}
    # Circuit        : [{circuit_number}] {circuit_description}
    # Layers         : {n_layers}  |  Parameters: {N_PARAMS}
    # Requires: pyquil (QVM running), numpy
    # Start QVM:   docker run --rm -p <QVM_PORT>:5000   rigetti/qvm   -S
    # Start Quilc: docker run --rm -p <QUILC_PORT>:5555 rigetti/quilc -R
